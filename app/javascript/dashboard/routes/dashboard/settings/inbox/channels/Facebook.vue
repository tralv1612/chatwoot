  ...
  methods: {
    ...
    tryFBlogin() {
      FB.login(
        ...
        {
          scope:
            'pages_manage_metadata,business_management,pages_manage_posts,pages_manage_engagement,pages_messaging,instagram_basic,pages_show_list,pages_read_engagement,instagram_manage_messages',
        }
      );
    },
