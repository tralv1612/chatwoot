...
ActiveRecord::Schema[7.1].define(version: 2025_08_16_103000) do
  ...
  create_table "log_events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_log_events_on_account_id"
    t.index ["contact_id"], name: "index_log_events_on_contact_id"
    t.index ["inbox_id"], name: "index_log_events_on_inbox_id"
  end
  ...
  add_foreign_key "log_events", "accounts"
  add_foreign_key "log_events", "contacts"
  add_foreign_key "log_events", "inboxes"
